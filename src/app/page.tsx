  ...
  return (
    <>
      ...
      <div className="relative z-10 max-w-[900px] mx-auto px-4 sm:px-6">
        {/* ─── Presale Ended Banner ─── */}
        <a
          href="https://presale.arcabot.ai"
          target="_blank"
          rel="noopener"
          className="block mt-4 mb-2 px-4 py-3 rounded-xl bg-gradient-to-r from-slate-500/10 via-slate-500/5 to-slate-500/10 border border-slate-500/20 no-underline transition-all duration-300 hover:border-slate-500/40 hover:from-slate-500/15 hover:to-slate-500/15 group"
        >
